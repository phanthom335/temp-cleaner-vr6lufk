    """
    Temp Cleaner Vr6lufk
    ====================
    Lightweight terminal utility built to archive your filesystem and configurations.
...
return results
    ...
    def build_parser() -> argparse.ArgumentParser:
        p = argparse.ArgumentParser(prog=APP_NAME, description="Lightweight terminal utility built to archive your filesystem and configurations.")
